...
import time
file_stats = Path('../../data/raw/lichess/reduced_lichess.pgn').stat()
file_size = 0
games_buffer = []
start_time = time.perf_counter()
max_file_size = 1000000000
games_finished = False
with open('../../data/raw/lichess.pgn') as lichess_file, open('../../data/raw/lichess/reduced_lichess.pgn', 'w') as outfile:
        while file_size < max_file_size and not games_finished:
            ...
            outfile.write(chunk)
            file_size = Path('../../data/raw/lichess/reduced_lichess.pgn').stat().st_size
            print(file_size)
            games_buffer.clear()
